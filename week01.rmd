...
Textbook code can be found [here](https://github.com/genomicsclass/labs/raw/master/intro/getting_started.Rmd) or downloaded:
```{r, eval=FALSE, tidy=TRUE}
download("https://github.com/genomicsclass/labs/raw/master/intro/getting_started.Rmd","getting_started.Rmd")
```
...
Textbook code can be found [here](https://github.com/genomicsclass/labs/raw/master/intro/dplyr_intro.Rmd) or downloaded:
```{r, eval=FALSE, tidy=TRUE}
download("https://github.com/genomicsclass/labs/raw/master/intro/dplyr_intro.Rmd","dplyr_intro.Rmd")
```
