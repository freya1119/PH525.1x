...
Textbook code can be found [here](https://github.com/genomicsclass/labs/raw/master/intro/getting_started.Rmd) or download:
```{r, eval=FALSE}
...
Textbook code can be found [here](https://github.com/genomicsclass/labs/raw/master/intro/dplyr_intro.Rmd) or download:
```{r, eval=FALSE}
